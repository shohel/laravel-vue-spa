<template>
    <div>
        ...
        <div class="tags-container" v-if="results">
            ...
            <div class="jumbotron p-3 p-md-5 rounded bg-light">
                <div class="col-md-12 px-0 text-center">
                    <h1 class="display-4 font-italic">Tag : {{tag.tag_name}}</h1>
        ...
        <div class="error-no-data" v-else>
            <h3 class="display-4"> <i class="fas fa-info-circle"></i> There is no data found</h3>
        </div>
...
<script>
    ...
    export default {
        ...
        mounted: function(){
            ...
            let api_uri = laravel.route.get_tag_posts.replace('{slug}', this.$route.params.slug);
            axios.get(api_uri+params)
                .then(function(res){
                    app.is_loading = false;
                    if (res.data.success){
                        app.tag = res.data.data.tag;
